...
type Merchant struct {
	ID           string
	CountryID    string // Which country this merchant belongs to
	StoredGold   int    // Personal savings (can take when fleeing)
	InvestedGold int    // Gold invested (doubles next turn, lost if fleeing)
}
